...
treeWrapper.style.cursor = "pointer"
treeWrapper.addEventListener("mouseover", function () {
    treeWrapper.style.scale = 1.05
})
treeWrapper.addEventListener("mouseout", function () {
    treeWrapper.style.scale = 1
})
